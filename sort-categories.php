...
<div id="products">
    ...
    <div class="container">
		...
		<div class="row"><div class="col-12" align="center"><h3 style="text-transform: capitalize"><?php get_category_name($cid); ?></h3><p></p><br><br></div></div>
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<form method="post" action="sort-cat.php">
        ...
        <div class="row" id="page">
            ...
            <?php sort_pull_products($cid, $sort); ?>
