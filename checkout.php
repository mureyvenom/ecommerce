...
<div id="product">
	<div class="container">
		<div class="row">
        	...
        	<div class="col-md-5">
            <form action="proc-checkout.php" role="form" enctype="multipart/form-data" class="form-horizontal" method="post">  
                <!-- Checkout Accordion -->
...
-->
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">					
                    ...
                    <p>&nbsp;</p>
					<p></p>
					<div>Note that any coupon discount will be calculated upon submission</div>
                </div>
            </div>
